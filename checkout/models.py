...
class Order(models.Model):
    ...
    # Postcode is not required and can be left blank
    ...
    # County is not required and can be left blank
    county = models.CharField(max_length=80, null=True, blank=True)
    # Set order date and time whenever a new order is created
...
# Relates each line on an order to the parent model (Order)
